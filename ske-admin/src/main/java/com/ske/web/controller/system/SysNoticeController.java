...
import com.ske.system.domain.SysNotice;
import com.ske.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController
{
    ...
    {
        notice.setSkeCreateBy(getUsername());
    ...
    {
        notice.setSkeUpdateBy(getUsername());
